                            ...
                            <div class="col-lg-4 col-md-5 col-sm-8 order-2 order-md-3">
                                <div class="header-widget-2 text-center text-sm-right ">
                                    ...
                                    <ul class="header-links">
                                        ...
                                        <li><a href="login-register.html"><i class="fas fa-user"></i> Register or Sign
                                                in</a></li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="login-form">
                          <div class="row">
                            <div class="col-md-12 col-12 mb--20">
                              <label>Objet</label>
                              <input class="mb-0" type="text" placeholder="sujet">
                            </div>
                            <div class="col-md-12 col-12 mb--20">
                                <label>Type animal</label>
                                <input class="mb-0" type="text" placeholder="type de votre animal">
                              </div>
                            <div class="col-12 mb--20">
                              <label>age</label>
                              <input class="mb-0" type="text" placeholder="age (exp: 1 mois / 2 ans ...)">
                            </div>
                            <div class="col-12 mb--20">
                            ...
                            <div class="col-md-12">
                              <div class="d-flex align-items-center flex-wrap">
                                <button class="btn btn-black   mr-3">envoyer</button>
                              </div>
                            </div>
