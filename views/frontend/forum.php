...
<?php 
   ...
   require_once '../../controllers/utilisateurs/UtilisateurC.php';
    ...
    if (isset( $_SESSION['id']) &&  isset($_POST["typeR"]) && isset($_POST["messageR"])) 
    {
        if (!empty($_POST["typeR"]) && !empty($_POST["messageR"]))
        {


  $form= new Sujet(66,(int) $_SESSION['id'], $_POST['typeR'], $_POST['messageR'],date("Y-m-d h:i:sa"));
                    ...
                    <div class="media forum-item">
                        ...
                        <div class="media-body">
                            <h6><a data-toggle="" data-target=".forum-content" class="text-body">
                                    <?php echo $userC->recupererUtilisateur1($sujet['id_utilisateur'])['nom']; ?></a>
                            </h6>
                            <a data-toggle="" data-target=".forum-content" class="text-body">
                                <?php echo $sujet['type']; ?></a>
                            <p class="text-secondary">
                                <?php echo $sujet['message']; ?>
                            </p>
                            <p class="text-muted"><a href="javascript:void(0)"> Poster le :</a> <span
                                    class="text-secondary font-weight-bold"><?php echo $sujet['date_p']; ?></span></p>
                        </div>
      ...
      ?>
        ...
        <section class="contact-page-section overflow-hidden">
            ...
            <button class="btn btn-primary has-icon btn-block" type="button" data-toggle="modal"
                data-target="#threadModal" style="width:30%">
                    ...
                    <div class="modal-content">
                        <form action="" method="post">
                            ...
                            <div class="modal-body">
                                ...
                                <textarea type="text" id="message" name="messageR" placeholder="message"
