                            ...
                            <div class="col-lg-4 col-md-5 col-sm-8 order-2 order-md-3">
                                <div class="header-widget-2 text-center text-sm-right ">
                                    <div class="call-widget">
                                        <p>Appellez Nous: <i class="icon ion-ios-telephone"></i><span class="font-weight-mid">+216 52 73 93 85</span></p>
                                    </div>
                                            ...
                                            <ul class="megamenu three-column">
                                                ...
                                                <li>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a
                                                                href="shop-left-sidebar2.php?page=1"><?=$cath['designation'];?></a>
                                                        </li>
                                                        <?php endforeach; ?>
                                                    </ul>
                                                </li>
                                            ...
                                            <ul class="megamenu three-column">
                                                ...
                                                <li>
                                                    ...
                                                    <ul>
                                                        ...
                                                        ?>
                                                        <li><a
                                                                href="product-details.html"><?= $cath1['designation'];?></a>
                                                        </li>
                                                        <?php endforeach; ?>
                                                    </ul>
                                                </li>
