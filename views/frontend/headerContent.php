                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-sm-6 text-center text-sm-left">
                                <p class="font-weight-300">Welcome Naturalist Web site</p>
                            </div>
                            <div class="col-sm-6">
                    ...
                    <div class="container">
                        <div class="row align-items-center justify-content-center">
                            ...
                            <div class="col-lg-5 col-md-7 order-3 order-md-2">
                                ...
                                <div class="list-group" style="position: absolute ; width:94%; display:none; z-index:99">
                                <div id="show-list">
                                ...
                                <nav class="main-navigation">
                                    ...
                                    <ul class="mainmenu">
                                        ...
                                        <li class="mainmenu__item menu-item-has-children ">
                                            <a href="shop-left-sidebar.php?page=1" class="mainmenu__link">Produits</a>
                                            <ul class="megamenu three-column">
                                                ...
                                                <li>
                                                    ...
                                                    <?php 
                                                            ...
                                                            ?>
                                                            <li>
                                                                <a href="shop-left-sidebar.php?page=1"><?=$cath['designation'];?></a>
                                                            </li>
                                                        <?php endforeach; ?>
                                                    </ul>
                                                </li>
                            ...
                            <div class="col-lg-9">
                                ...
                                <nav class="sticky-navigation">
                                    <ul class="mainmenu sticky-menu">
                                        ...
                                        <li class="mainmenu__item ">
                                            <a href="portfolio.html" class="mainmenu__link">e-consultation</a>
                                        </li>
                                        <li class="mainmenu__item">
                                            <a href="blog.html" class="mainmenu__link">Blog</a>
                                        </li>
