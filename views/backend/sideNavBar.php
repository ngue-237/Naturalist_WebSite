      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li><a href="index.php"> <i class="fas fa-blog"></i>Blog</a></li>
            <li><a href="index.php"> <i class="fas fa-comments"></i>Forum </a></li>
            ...
            <li><a href="statProd.php"> <i class="fas fa-chart-pie"></i>Statistiques</a></li> 
          </ul>
        </div>
      </div>
    </nav>